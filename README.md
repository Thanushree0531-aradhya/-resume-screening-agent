...
│   ├── skills.py             # Keyword-based skill extraction & matching
│   ├── scorer.py             # Combines scores, ranks resumes
│   └── explain.py            # LLM-generated score explanations (Groq)
└── resume-frontend/
    ├── src/
